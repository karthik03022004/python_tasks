...
# print(high,name)
# '''--------------------------------------------------------------------'''
# return the max marks and sub
# stu={
#     "name":"siva",
#     "marks":{"tel":90,"hin":67,"eng":99,"mat":99,"soc":100}
# }
# l=[]
# max=0
# for i in stu:
...
# print(max,l)
# '''--------------------------------------------------------------------'''
# print companies of loc north america
# emp={
#     "companies":[{"name":"google","loc":"north america"},{"name":"microsoft","loc":"north america"},{"name":"Tcs","loc":"india"}]
# }
# cmpy_name=[]
# for i in emp["companies"]:
#     for j in i:
#         if(i[j]=="north america"):
#             cmpy_name.append(i["name"])
# print(cmpy_name)
...
# return id with less than 50/-
# for i in products:
#     if(i['price']<50):
#         print(i['title'])
'''retuen product title whose rating more than 4'''
# for i in products:
#     if(i['rating']['rate']>4):
#         print(i['title'],i['id'],i['rating']['rate'])
mens=[]
womens=[]
jewel=[]
electro=[]
for i in products:
    ...
    if(i['category']=="women's clothing"):
        womens.append(i["title"])
    if(i['category']=="electronics"):
        electro.append(i['title'])
    if(i['category']=='jewelery'):
        jewel.append(i['title'])
    
    
print(f"{mens} and number of mens produts:{len(mens)}")
print(f"{womens} and number of womens products:{len(womens)}")
print(f"{electro} and number of electronics:{len(electro)}")
print(f"{jewel} and number of jewelery :{len(jewel)}")
